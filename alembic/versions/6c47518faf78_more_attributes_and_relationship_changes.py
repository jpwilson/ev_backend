"""more attributes and relationship changes

Revision ID: 6c47518faf78
Revises: 83405c8c273a
Create Date: 2023-11-09 11:02:33.748419
...
revision: str = '6c47518faf78'
down_revision: Union[str, None] = '83405c8c273a'
...
def downgrade() -> None:
    ...
    sa.Column('epa_range', sa.FLOAT(), nullable=True),
    ...
    sa.Column('interior_lighting_details', sqlite.JSON(), nullable=True),
    ...
    sa.Column('dog_mode', sqlite.JSON(), nullable=True),
    sa.Column('infotainment_details', sqlite.JSON(), nullable=True),
    sa.Column('camping_features', sqlite.JSON(), nullable=True),
